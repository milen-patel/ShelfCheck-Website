...
<p>To ensure real-time data, our data is crowdsourced by users. While we take measures to minimize the number of false reports and inaccurate data, all reports posted on our site are estimations and we cannot guarantee 100% accuracy. We use models to estimate how many items should be left by taking the time since the latest report, however due to unexpected shopping tendencies, this data might be slightly inaccurate. We always strive to improve accuracy, and if you have suggestions please contact us at contact.shelfcheck@gmail.com By using shelfCheck you agree to comply with local laws and health and safety requirements at all governmental levels. Along with this, we encourage social distancing while shopping. While we cannot mandate this condition, the purpose of shelfCheck is to mitigate contact during a time where social distancing is paramount, so please respect other shoppers while using shelfCheck.</p>
